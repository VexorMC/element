...
public class PostPass implements AutoCloseable {
	...
	public PostPass(RenderPipeline renderPipeline, Identifier resourceLocation, Map<String, List<UniformValue>> map, List<PostPass.Input> list) {
	...
	public record TargetInput(String samplerName, Identifier targetId, boolean depthBuffer, boolean bilinear) implements PostPass.Input {
		...
		@Override
		public void cleanup(Map<Identifier, ResourceHandle<RenderTarget>> map) {
			if (this.bilinear) {
