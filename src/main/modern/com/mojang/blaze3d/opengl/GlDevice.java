...
public class GlDevice implements GpuDevice {
	...
	public GlDevice(long l, int i, boolean bl, BiFunction<Identifier, ShaderType, String> biFunction, boolean bl2) {
	...
	public GlRenderPipeline precompilePipeline(RenderPipeline renderPipeline, @Nullable BiFunction<Identifier, ShaderType, String> biFunction) {
		BiFunction<Identifier, ShaderType, String> biFunction2 = biFunction == null ? this.defaultShaderSource : biFunction;
	...
	private GlShaderModule compileShader(GlDevice.ShaderCompilationKey shaderCompilationKey, BiFunction<Identifier, ShaderType, String> biFunction) {
	...
	private GlRenderPipeline compilePipeline(RenderPipeline renderPipeline, BiFunction<Identifier, ShaderType, String> biFunction) {
