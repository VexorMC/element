...
public class RenderPipeline {
	...
	public static class Builder {
		...
		public RenderPipeline.Builder withLocation(Identifier resourceLocation) {
		...
		public RenderPipeline.Builder withFragmentShader(Identifier resourceLocation) {
		...
		public RenderPipeline.Builder withVertexShader(Identifier resourceLocation) {
