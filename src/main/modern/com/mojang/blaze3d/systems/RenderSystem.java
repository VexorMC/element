...
public class RenderSystem {
	...
	private static final ArrayDeque<GpuAsyncTask> PENDING_FENCES = new ArrayDeque<>();
	@Nullable
	...
	private static void pollEvents() {
		pollEventsWaitStart.set(System.currentTimeMillis());
	...
	public static boolean isFrozenAtPollEvents() {
		return pollingEvents.get() && System.currentTimeMillis() - pollEventsWaitStart.get() > 200L;
	}
	...
	public static void initRenderer(long l, int i, boolean bl, BiFunction<Identifier, ShaderType, String> biFunction, boolean bl2) {
