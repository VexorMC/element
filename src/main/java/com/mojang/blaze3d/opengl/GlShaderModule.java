...
public class GlShaderModule implements AutoCloseable {
	...
	public GlShaderModule(int i, Identifier resourceLocation, ShaderType shaderType) {
		this.id = resourceLocation;
		this.shaderId = i;
		this.type = shaderType;
	}

	public static GlShaderModule compile(Identifier resourceLocation, ShaderType shaderType, String string) throws ShaderManager.CompilationException {
