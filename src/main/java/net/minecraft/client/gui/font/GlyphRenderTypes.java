...
public record GlyphRenderTypes(RenderType normal, RenderType seeThrough, RenderType polygonOffset, RenderPipeline guiPipeline) {
	public static GlyphRenderTypes createForIntensityTexture(Identifier resourceLocation) {
	...
	public static GlyphRenderTypes createForColorTexture(Identifier resourceLocation) {
		return new GlyphRenderTypes(
