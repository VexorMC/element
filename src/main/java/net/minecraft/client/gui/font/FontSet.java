...
public class FontSet implements AutoCloseable {
	...
	public FontSet(TextureManager textureManager, Identifier resourceLocation) {
	...
	private BakedGlyph stitch(SheetGlyphInfo sheetGlyphInfo) {
		...
		Identifier resourceLocation = this.name.withSuffix("/" + this.textures.size());
		...
		this.textureManager.loadTexture(resourceLocation, fontTexture2);
