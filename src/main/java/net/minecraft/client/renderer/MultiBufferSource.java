...
public interface MultiBufferSource {
	...
	static MultiBufferSource.BufferSource immediateWithBuffers(Map<RenderType, ByteBufferBuilder> sequencedMap, ByteBufferBuilder byteBufferBuilder) {
	...
	public static class BufferSource implements MultiBufferSource {
		...
		protected BufferSource(ByteBufferBuilder byteBufferBuilder, Map<RenderType, ByteBufferBuilder> sequencedMap) {
