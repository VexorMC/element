...
public abstract class RenderType extends RenderStateShard {
	...
	private static final Function<Identifier, RenderType> ARMOR_CUTOUT_NO_CULL = Util.memoize(
		(Function<Identifier, RenderType>)(resourceLocation -> {
	...
	private static final BiFunction<Identifier, Boolean, RenderType> ENTITY_CUTOUT_NO_CULL = Util.memoize(
		(BiFunction<Identifier, Boolean, RenderType>)((resourceLocation, boolean_) -> {
			RenderType.CompositeState compositeState = RenderType.CompositeState.builder()
				.setTextureState(new RenderStateShard.TextureStateShard(resourceLocation, false))
				.setLightmapState(LIGHTMAP)
				.setOverlayState(OVERLAY)
...
//	);
	...
	private static final Function<Identifier, RenderType> TEXT = Util.memoize(
		(Function<Identifier, RenderType>)(resourceLocation -> create(
			"text",
			786432,
			false,
			false,
		...
		RenderType.CompositeState.builder()
			.setTextureState(
				RenderStateShard.MultiTextureStateShard.builder()
					.add(new Identifier("textures/environment/end_sky.png"), false)
					.add(new Identifier("textures/entity/end_portal.png"), false)
					.build()
			)
			.createCompositeState(false)
	);
	...
	private static final Function<Identifier, RenderType> OPAQUE_PARTICLE = Util.memoize(
		(Function<Identifier, RenderType>)(resourceLocation -> create(
			"opaque_particle",
			1536,
			false,
	...
	private static final Function<Identifier, RenderType> TRANSLUCENT_PARTICLE = Util.memoize(
		(Function<Identifier, RenderType>)(resourceLocation -> create(
	...
	private static final Function<Identifier, RenderType> CELESTIAL = Util.memoize(
		(Function<Identifier, RenderType>)(resourceLocation -> create(
			"celestial",
			1536,
			false,
	...
	public static RenderType armorCutoutNoCull(Identifier resourceLocation) {
		return (RenderType)ARMOR_CUTOUT_NO_CULL.apply(resourceLocation);
	}

	public static RenderType createArmorDecalCutoutNoCull(Identifier resourceLocation) {
		RenderType.CompositeState compositeState = RenderType.CompositeState.builder()
			.setTextureState(new RenderStateShard.TextureStateShard(resourceLocation, false))
			.setLightmapState(LIGHTMAP)
			.setOverlayState(OVERLAY)
	...
	public static RenderType armorTranslucent(Identifier resourceLocation) {
		return (RenderType)ARMOR_TRANSLUCENT.apply(resourceLocation);
	}

	public static RenderType entitySolid(Identifier resourceLocation) {
		return (RenderType)ENTITY_SOLID.apply(resourceLocation);
	}

	public static RenderType entitySolidZOffsetForward(Identifier resourceLocation) {
	...
	public static RenderType entityCutoutNoCull(Identifier resourceLocation, boolean bl) {
		return (RenderType)ENTITY_CUTOUT_NO_CULL.apply(resourceLocation, bl);
	}

	public static RenderType entityCutoutNoCull(Identifier resourceLocation) {
		return entityCutoutNoCull(resourceLocation, true);
	}

	public static RenderType entityCutoutNoCullZOffset(Identifier resourceLocation, boolean bl) {
		return (RenderType)ENTITY_CUTOUT_NO_CULL_Z_OFFSET.apply(resourceLocation, bl);
	}

	public static RenderType entityCutoutNoCullZOffset(Identifier resourceLocation) {
		return entityCutoutNoCullZOffset(resourceLocation, true);
	}

	public static RenderType itemEntityTranslucentCull(Identifier resourceLocation) {
		return (RenderType)ITEM_ENTITY_TRANSLUCENT_CULL.apply(resourceLocation);
	}

	public static RenderType entityTranslucent(Identifier resourceLocation, boolean bl) {
		return (RenderType)ENTITY_TRANSLUCENT.apply(resourceLocation, bl);
	}

	public static RenderType entityTranslucent(Identifier resourceLocation) {
		return entityTranslucent(resourceLocation, true);
	}

	public static RenderType entityTranslucentEmissive(Identifier resourceLocation, boolean bl) {
	...
	public static RenderType entitySmoothCutout(Identifier resourceLocation) {
	...
	public static RenderType entityDecal(Identifier resourceLocation) {
		return (RenderType)ENTITY_DECAL.apply(resourceLocation);
	}

	public static RenderType entityNoOutline(Identifier resourceLocation) {
		return (RenderType)ENTITY_NO_OUTLINE.apply(resourceLocation);
	}

	public static RenderType entityShadow(Identifier resourceLocation) {
		return (RenderType)ENTITY_SHADOW.apply(resourceLocation);
	}

	public static RenderType dragonExplosionAlpha(Identifier resourceLocation) {
		return (RenderType)DRAGON_EXPLOSION_ALPHA.apply(resourceLocation);
	}

	public static RenderType eyes(Identifier resourceLocation) {
		return (RenderType)EYES.apply(resourceLocation);
	}

	public static RenderType breezeEyes(Identifier resourceLocation) {
		return (RenderType)ENTITY_TRANSLUCENT_EMISSIVE.apply(resourceLocation, false);
	}

	public static RenderType breezeWind(Identifier resourceLocation, float f, float g) {
		return create(
			"breeze_wind",
			1536,
			false,
	...
	public static RenderType energySwirl(Identifier resourceLocation, float f, float g) {
		return create(
			"energy_swirl",
			1536,
			false,
	...
	public static RenderType outline(Identifier resourceLocation) {
...
//	}
	...
	public static RenderType crumbling(Identifier resourceLocation) {
		return (RenderType)CRUMBLING.apply(resourceLocation);
	}

	public static RenderType text(Identifier resourceLocation) {
	...
	public static RenderType textIntensity(Identifier resourceLocation) {
		return (RenderType)TEXT_INTENSITY.apply(resourceLocation);
	}

	public static RenderType textPolygonOffset(Identifier resourceLocation) {
		return (RenderType)TEXT_POLYGON_OFFSET.apply(resourceLocation);
	}

	public static RenderType textIntensityPolygonOffset(Identifier resourceLocation) {
		return (RenderType)TEXT_INTENSITY_POLYGON_OFFSET.apply(resourceLocation);
	}

	public static RenderType textSeeThrough(Identifier resourceLocation) {
	...
	public static RenderType textIntensitySeeThrough(Identifier resourceLocation) {
	...
	public static RenderType opaqueParticle(Identifier resourceLocation) {
		return (RenderType)OPAQUE_PARTICLE.apply(resourceLocation);
	}

	public static RenderType translucentParticle(Identifier resourceLocation) {
	...
	public static RenderType weather(Identifier resourceLocation, boolean bl) {
	...
	public static RenderType celestial(Identifier resourceLocation) {
		return (RenderType)CELESTIAL.apply(resourceLocation);
	}

	public static RenderType blockScreenEffect(Identifier resourceLocation) {
		return (RenderType)BLOCK_SCREEN_EFFECT.apply(resourceLocation);
	}

	public static RenderType fireScreenEffect(Identifier resourceLocation) {
	...
	static final class CompositeRenderType extends RenderType {
		static final BiFunction<Identifier, Boolean, RenderType> OUTLINE = Util.memoize(
			(BiFunction<Identifier, Boolean, RenderType>)((resourceLocation, boolean_) -> RenderType.create(
				"outline",
				1536,
