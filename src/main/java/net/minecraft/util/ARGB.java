...
public class ARGB {
	...
	public static int color(Vec3d vec3) {
	...
	public static int scaleRGB(int i, float f, float g, float h) {
		return color(alpha(i), Mth.clamp((int)(red(i) * f), 0, 255), Mth.clamp((int)(green(i) * g), 0, 255), Mth.clamp((int)(blue(i) * h), 0, 255));
	}

	public static int scaleRGB(int i, int j) {
		return color(
			alpha(i), (int)Mth.clamp((long)red(i) * j / 255L, 0, 255), (int)Mth.clamp((long)green(i) * j / 255L, 0, 255), (int)Mth.clamp((long)blue(i) * j / 255L, 0, 255)
		);
	}
	...
	public static int lerp(float f, int i, int j) {
		int k = (int)Mth.clampedLerp(f, alpha(i), alpha(j));
		int l = (int)Mth.clampedLerp(f, red(i), red(j));
		int m = (int)Mth.clampedLerp(f, green(i), green(j));
		int n = (int)Mth.clampedLerp(f, blue(i), blue(j));
